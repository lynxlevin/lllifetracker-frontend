...
export const ObjectiveIcon = ({ size = 'medium' }: CustomIconProps) => {
    return <AutoAwesomeIcon sx={{ backgroundColor: 'objectives.100', borderRadius: 100, display: 'inline', ...getSize(size) }} />;
};
